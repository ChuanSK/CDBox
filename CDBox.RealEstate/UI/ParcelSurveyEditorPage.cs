...
")
                ...
                .Append("<div class=\"top-right\"><div class=\"actions\"><button id=\"saveParcel\" class=\"btn\" type=\"button\">保存宗地信息</button><button id=\"checkData\" class=\"btn\" type=\"button\">检查数据</button><button id=\"exportSurvey\" class=\"btn primary\" type=\"button\">导出调查表</button></div>")
