...
using SimpleAnnotationHudModel = WastewaterBusiness::TCPipeAutoDraw.Modules.AnnotationHud.SimpleAnnotationHudModel;
using SimpleAnnotationKind = WastewaterBusiness::TCPipeAutoDraw.Modules.AnnotationHud.SimpleAnnotationKind;
using System;
...
namespace TCPipeAutoDraw.Modules.AnnotationHud
{
    internal sealed class SimpleAnnotationHudWindow : AnnotationHudWindowBase
    {
        ...
        public SimpleAnnotationHudWindow() : base("CDBox 标注浮窗", 330, true)
        {
            ...
            {
                Height = 1,
                Background = TCPipeAutoDraw.UI.Studio.WastewaterNativeAppearance.Brush("#DCE5F1"),
            ...
            _status = new TextBlock
            {
                ...
                Foreground = TCPipeAutoDraw.UI.Studio.WastewaterNativeAppearance.Brush("#B43A3A"),
                FontSize = 11.5,
        ...
        private void RebuildTextRows(SimpleAnnotationHudModel model)
        {
            ...
            for (int i = 0; i < model.Lines.Count; i++)
            {
                ...
                var label = new TextBlock
                {
                    ...
                    Foreground = TCPipeAutoDraw.UI.Studio.WastewaterNativeAppearance.Brush("#607089"),
                    FontSize = 11.2,
        ...
        private void SetStatus(string message, bool isError)
        {
            ...
            _status.Foreground = isError ? TCPipeAutoDraw.UI.Studio.WastewaterNativeAppearance.Brush("#B43A3A") : TCPipeAutoDraw.UI.Studio.WastewaterNativeAppearance.Brush("#3B6B4A");
        ...
        private static TextBox CreateTextBox()
        {
            return new TextBox
            {
                ...
                BorderBrush = TCPipeAutoDraw.UI.Studio.WastewaterNativeAppearance.Brush("#C7D4E5"),
                BorderThickness = new Thickness(1),
                Background = TCPipeAutoDraw.UI.Studio.WastewaterNativeAppearance.Brush("#FAFCFF"),
