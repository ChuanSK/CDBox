...
using SectionDrawingService = WastewaterBusiness::TCPipeAutoDraw.Modules.SectionDrawing.SectionDrawingService;
using SectionDrawingSettingsStore = WastewaterBusiness::TCPipeAutoDraw.Modules.SectionDrawing.SectionDrawingSettingsStore;
    ...
    public sealed class SectionDrawingForm : Form
    {
       ...
       //private Label _lblStatus;
        ...
        public SectionDrawingForm(Document doc)
        {
            ...
            BuildUi();
            TCPipeAutoDraw.UI.Studio.WastewaterNativeAppearance.Register(this);
            LoadInitialValues();
        ...
        {
            var group = new TCPipeAutoDraw.UI.Studio.WastewaterSectionGroup();
            group.Text = "层级操作";
        ...
        {
            if (index == _selectedLayerIndex) return TCPipeAutoDraw.UI.Studio.WastewaterNativeAppearance.Selected;
            if (index >= 0 && index < _layers.Count && _layers[index] != null && !_layers[index].DrawLayer)
            {
                return TCPipeAutoDraw.UI.Studio.WastewaterNativeAppearance.Background;
            }
            return TCPipeAutoDraw.UI.Studio.WastewaterNativeAppearance.Background;
        }
