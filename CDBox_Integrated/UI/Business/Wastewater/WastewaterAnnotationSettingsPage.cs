...
using NodeAnnotationSettingsStore = WastewaterBusiness::TCPipeAutoDraw.Modules.NodeAnnotation.NodeAnnotationSettingsStore;
using PipeLengthAnnotationSettingsStore = WastewaterBusiness::TCPipeAutoDraw.Modules.PipeLengthAnnotation.PipeLengthAnnotationSettingsStore;
using SurfaceAreaAnnotationOptions = WastewaterBusiness::TCPipeAutoDraw.Modules.SurfaceAreaAnnotation.SurfaceAreaAnnotationOptions;
using SurfaceAreaAnnotationSettingsStore = WastewaterBusiness::TCPipeAutoDraw.Modules.SurfaceAreaAnnotation.SurfaceAreaAnnotationSettingsStore;
using System;
using System.Text;
...
namespace CDBox.Wastewater.UI
{
    ...
    public sealed class WastewaterAnnotationSettingsPage
    {
            ...
            NodeAnnotationOptions node)
        {
            ...
            return TCPipeAutoDraw.UI.Studio.WastewaterWorkbench.Apply(html.ToString(), "annotations", appearance.Theme, appearance.AnimationsEnabled);
        }
