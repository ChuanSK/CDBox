...
namespace TCPipeAutoDraw.UI.Studio
{
    internal static class CDBoxStudioQuantityAttributeEditorWindow
    {
        ...
        public static void ShowWindow(IWin32Window owner, QuantityPipeSelectionInfo info, string documentId)
        {
            ...
            ReleaseStaleWindow();
            var window = new CDBoxStudioWebPageForm("属性编辑器 · 4.1.1", delegate { return CDBoxStudioQuantityAttributeEditorPage.BuildStandaloneDocument(CDBoxStudioSettingsStore.Load(), CDBoxStudioLogger.LogFilePath, _documentId, _handle); }, Route, "quantity-attribute-editor");
            _current = window;
            window.Width = 1180;
            window.Height = 820;
            ...
            CDBoxStudioLogger.Info("已打开属性编辑器 4.1.1 独立窗口。");
        }
