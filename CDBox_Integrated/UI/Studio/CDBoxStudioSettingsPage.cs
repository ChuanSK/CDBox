...
namespace TCPipeAutoDraw.UI.Studio
{
    internal static class CDBoxStudioSettingsPage
    {
        public static string BuildStandaloneDocument()
        {
            ...
            html.Append("<section class=\"card wide\"><h2>标注浮窗</h2><div class=\"hud-grid\">");
            ...
            html.Append("</div><p class=\"hud-note\">透明度 0% 对应安全最低透明度，100% 为完全不透明；保存后立即应用。</p></section>");
