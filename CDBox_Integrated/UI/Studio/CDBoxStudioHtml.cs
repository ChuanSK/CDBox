...
namespace TCPipeAutoDraw.UI.Studio
{
    internal static class CDBoxStudioHtml
    {
        ...
        public static string Build(IEnumerable<CDBoxStudioAction> actions, CDBoxStudioSettings settings, string runtimeVersion, string logFilePath, string settingsFilePath)
        {
            ...
            html = html.Replace("{{RELEASE_UPDATE_SCRIPT}}", CDBoxReleaseUpdatePage.BuildScript());
            return CDBoxAccentAppearance.Attach(html, settings);
        }
        ...
        private static string BuildCommandRows(List<CDBoxStudioAction> actions)
        {
            ...
            rows.Append("<button class=\"cmd-row\" data-command-row data-id=\"__checkUpdate\" data-search=\"检查更新 Stable Preview 版本服务 官网\"><span><strong>检查更新</strong></span><kbd>UPD</kbd></button>");
        ...
        private static string BuildSettingsPage(CDBoxStudioSettings settings, string settingsFilePath)
        {
            ...
            page.Append("<article class=\"setting-card wide update-card\">").Append(CDBoxReleaseUpdatePage.BuildControls(settings)).Append("</article>");
            page.Append("</div>");
...
{{SECTION_DRAWING_SCRIPT}}
  ...
  function showSettings(){active='总览';showHome();post('openSettingsWindow','');}
  ...
  function showQuantityDashboard(){active='总览';showHome();post('openQuantityDashboardWindow','');}
  ...
  function showSectionDrawing(){active='总览';showHome();post('openSectionDrawingWindow','');}
  ...
  function showAnnotationSettings(section){active='总览';showHome();post('openAnnotationSettingsWindow',section||'surface');}
  function showDefaultProfiles(){active='总览';showHome();post('openDefaultProfilesWindow','');}
  ...
  window.CDBoxReleaseUpdates.init(post,buildSettingsPayload);
