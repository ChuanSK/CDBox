...
namespace TCPipeAutoDraw.UI.Studio
{
    ...
    {
        public static readonly string CurrentVersion = ReadInformationalVersion("2.6.0-studio-preview.6");
        public static readonly int CurrentVersionCode = ReadAssemblyMetadataInt("CDBoxVersionCode", 20600);
        public static readonly string ReleaseIdentity = ReadAssemblyMetadata("CDBoxReleaseIdentity", "CDBox-Studio-Preview-6");
        public static readonly string ReleaseTitle = ReadAssemblyMetadata("CDBoxReleaseTitle", "CDBox Studio Preview 6");
