...
namespace TCPipeAutoDraw.UI.Studio
{
    ...
    {
        public static readonly string CurrentVersion = ReadInformationalVersion("3.6.1");
        public static readonly int CurrentVersionCode = ReadAssemblyMetadataInt("CDBoxVersionCode", 30601);
        public static readonly string ReleaseIdentity = ReadAssemblyMetadata("CDBoxReleaseIdentity", "CDBox-Studio-Preview-3.6.1");
        public static readonly string ReleaseTitle = ReadAssemblyMetadata("CDBoxReleaseTitle", "CDBox Studio Preview 3.6.1");
